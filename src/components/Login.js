...
export default class Login extends React.Component {
      ...
      loginSchema: Yup.object().shape({
        ...
        password: Yup.string()
          ...
          .matches(
            ...
            {
              message:
                "Password must include a UPPER CASE, NUMBER, SPECIAL CHARACTER",
  ...
  componentDidMount() {
    if (commonService.checkLoginStatus()) this.props.history.push("/home");
  }
  ...
  render() {
    return (
      <React.Fragment>
        ...
        {this.state.alert && (
          <Alert
            headingContent={this.state.alertHeading}
            messageContent={this.state.alertMessage}
          />
        )}
                        ...
                        {({
                          ...
                          >
                            ...
                            {errors.email && touched.email && errors.email && (
                              <span className="uk-alert-danger">
                                &#42;
                                {errors.email && touched.email && errors.email}
                              </span>
                            )}
